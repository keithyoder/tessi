...
prawn_document(:page_size => 'A4', :margin => [20.mm,20.mm,20.mm,20.mm]) do |pdf|
  ...
  pdf.text_box referencia[2..3] + '/20' + referencia[0..1], size: 12, at: [1.mm, 209.mm], width:  33.mm, height: 8.mm, align: :right
  pdf.text_box number_to_currency(@nf21.parsed_mestre(:bc_icms).to_i / 100.0), size: 12, at: [35.mm, 209.mm], width:  33.mm, height: 8.mm, align: :right
  pdf.text_box number_to_currency(@nf21.parsed_mestre(:icms).to_i / 100.0), size: 12, at: [70.mm, 209.mm], width:  33.mm, height: 8.mm, align: :right
  ...
  pdf.text_box number_to_currency(@nf21.nf21_itens.first.parsed_item(:bc_icms).to_i / 100.0), size: 12, at: [113.mm, 158.mm], width: 26.mm, align: :right
  pdf.text_box @nf21.nf21_itens.first.parsed_item(:aliquota).to_i.to_s+'%', size: 12, at: [141.mm, 158.mm], width: 26.mm, align: :right
  ...
  pdf.text_box "NATUREZA DA OPERAÇÃO: Prestação de Serviço de Comunicação
    ...
    Fonte IBPT Chave A5G7R1", size: 10, at: [esquerda, 65.mm], leading: 7, width:  120.mm, height: 50.mm

  pdf.text_box number_to_currency(@nf21.parsed_mestre(:valor_total).to_i / 100.0), size: 14, style: :bold, at: [126.mm,10.mm], width:  40.mm, height: 8.mm, align: :right
  pdf.text_box @nf21.parsed_mestre(:codigo_autenticacao).upcase.gsub(/(.{4})(?=.)/, '\1.\2'), size: 12, at: [1.mm,10.mm], width:  126.mm, height: 8.mm, align: :center
