...
class Nf21ItensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nf21_item" do
    assert_difference('Nf21Item.count') do
      post nf21_itens_url, params: { nf21_item: { item: @nf21_item.item, nf_21: @nf21_item.nf_21, references: @nf21_item.references, text: @nf21_item.text } }
    end
  ...
  test "should update nf21_item" do
    patch nf21_item_url(@nf21_item), params: { nf21_item: { item: @nf21_item.item, nf_21: @nf21_item.nf_21, references: @nf21_item.references, text: @nf21_item.text } }
