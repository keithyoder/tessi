...
class ContratosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contrato" do
    assert_difference('Contrato.count') do
      post contratos_url, params: { contrato: { adesao: @contrato.adesao, cancelamento: @contrato.cancelamento, dia_vencimento: @contrato.dia_vencimento, emite_nf: @contrato.emite_nf, numero_conexoes: @contrato.numero_conexoes, pessoa_id: @contrato.pessoa_id, plano_id: @contrato.plano_id, prazo_meses: @contrato.prazo_meses, primeiro_vencimento: @contrato.primeiro_vencimento, status: @contrato.status, valor_instalacao: @contrato.valor_instalacao } }
    end
  ...
  test "should update contrato" do
    patch contrato_url(@contrato), params: { contrato: { adesao: @contrato.adesao, cancelamento: @contrato.cancelamento, dia_vencimento: @contrato.dia_vencimento, emite_nf: @contrato.emite_nf, numero_conexoes: @contrato.numero_conexoes, pessoa_id: @contrato.pessoa_id, plano_id: @contrato.plano_id, prazo_meses: @contrato.prazo_meses, primeiro_vencimento: @contrato.primeiro_vencimento, status: @contrato.status, valor_instalacao: @contrato.valor_instalacao } }
