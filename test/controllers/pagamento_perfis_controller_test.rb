...
class PagamentoPerfisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pagamento_perfil" do
    assert_difference('PagamentoPerfil.count') do
      post pagamento_perfis_url, params: { pagamento_perfil: { agencia: @pagamento_perfil.agencia, carteira: @pagamento_perfil.carteira, cedente: @pagamento_perfil.cedente, conta: @pagamento_perfil.conta, nome: @pagamento_perfil.nome, tipo: @pagamento_perfil.tipo } }
    end
  ...
  test "should update pagamento_perfil" do
    patch pagamento_perfil_url(@pagamento_perfil), params: { pagamento_perfil: { agencia: @pagamento_perfil.agencia, carteira: @pagamento_perfil.carteira, cedente: @pagamento_perfil.cedente, conta: @pagamento_perfil.conta, nome: @pagamento_perfil.nome, tipo: @pagamento_perfil.tipo } }
