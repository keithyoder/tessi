...
class PontosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ponto" do
    assert_difference('Ponto.count') do
      post pontos_url, params: { ponto: { ip: @ponto.ip, nome: @ponto.nome, senha: @ponto.senha, servidor_id: @ponto.servidor_id, sistema: @ponto.sistema, tecnologia: @ponto.tecnologia, usuario: @ponto.usuario } }
    end
  ...
  test "should update ponto" do
    patch ponto_url(@ponto), params: { ponto: { ip: @ponto.ip, nome: @ponto.nome, senha: @ponto.senha, servidor_id: @ponto.servidor_id, sistema: @ponto.sistema, tecnologia: @ponto.tecnologia, usuario: @ponto.usuario } }
