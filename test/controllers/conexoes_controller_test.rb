...
class ConexoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conexao" do
    assert_difference('Conexao.count') do
      post conexoes_url, params: { conexao: { auto_bloqueio: @conexao.auto_bloqueio, bloqueado: @conexao.bloqueado, ip: @conexao.ip, pessoa_id: @conexao.pessoa_id, plano_id: @conexao.plano_id, ponto_id: @conexao.ponto_id, velocidade: @conexao.velocidade } }
    end
  ...
  test "should update conexao" do
    patch conexao_url(@conexao), params: { conexao: { auto_bloqueio: @conexao.auto_bloqueio, bloqueado: @conexao.bloqueado, ip: @conexao.ip, pessoa_id: @conexao.pessoa_id, plano_id: @conexao.plano_id, ponto_id: @conexao.ponto_id, velocidade: @conexao.velocidade } }
