...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { cnpj: @pessoa.cnpj, complemento: @pessoa.complemento, cpf: @pessoa.cpf, email: @pessoa.email, ie: @pessoa.ie, logradouro_id: @pessoa.logradouro_id, nascimento: @pessoa.nascimento, nome: @pessoa.nome, nomemae: @pessoa.nomemae, numero: @pessoa.numero, rg: @pessoa.rg, telefone1: @pessoa.telefone1, telefone2: @pessoa.telefone2, tipo: @pessoa.tipo } }
    end
