...
class AtendimentoDetalhesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atendimento_detalhe" do
    assert_difference('AtendimentoDetalhe.count') do
      post atendimento_detalhes_url, params: { atendimento_detalhe: { atendente_id: @atendimento_detalhe.atendente_id, atendimento_id: @atendimento_detalhe.atendimento_id, descricao: @atendimento_detalhe.descricao, tipo: @atendimento_detalhe.tipo } }
    end
  ...
  test "should update atendimento_detalhe" do
    patch atendimento_detalhe_url(@atendimento_detalhe), params: { atendimento_detalhe: { atendente_id: @atendimento_detalhe.atendente_id, atendimento_id: @atendimento_detalhe.atendimento_id, descricao: @atendimento_detalhe.descricao, tipo: @atendimento_detalhe.tipo } }
