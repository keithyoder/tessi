...
class ConexaoEnviarAtributosControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create conexao_enviar_atributo' do
    assert_difference('ConexaoEnviarAtributo.count') do
      post conexao_enviar_atributos_url,
           params: { conexao_enviar_atributo: { atributo: @conexao_enviar_atributo.atributo,
                                                conexao_id: @conexao_enviar_atributo.conexao_id, op: @conexao_enviar_atributo.op, valor: @conexao_enviar_atributo.valor } }
    end
  ...
  test 'should update conexao_enviar_atributo' do
    patch conexao_enviar_atributo_url(@conexao_enviar_atributo),
          params: { conexao_enviar_atributo: { atributo: @conexao_enviar_atributo.atributo,
                                               conexao_id: @conexao_enviar_atributo.conexao_id, op: @conexao_enviar_atributo.op, valor: @conexao_enviar_atributo.valor } }
