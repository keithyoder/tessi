...
class LogradourosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create logradouro" do
    assert_difference('Logradouro.count') do
      post logradouros_url, params: { logradouro: { bairro_id: @logradouro.bairro_id, cep: @logradouro.cep, nome: @logradouro.nome } }
    end
  ...
  test "should update logradouro" do
    patch logradouro_url(@logradouro), params: { logradouro: { bairro_id: @logradouro.bairro_id, cep: @logradouro.cep, nome: @logradouro.nome } }
