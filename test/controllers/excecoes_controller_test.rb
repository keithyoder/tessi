...
class ExcecoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create excecao" do
    assert_difference('Excecao.count') do
      post excecoes_url, params: { excecao: { contrato_id: @excecao.contrato_id, tipo: @excecao.tipo, usuario: @excecao.usuario, valido_ate: @excecao.valido_ate } }
    end
  ...
  test "should update excecao" do
    patch excecao_url(@excecao), params: { excecao: { contrato_id: @excecao.contrato_id, tipo: @excecao.tipo, usuario: @excecao.usuario, valido_ate: @excecao.valido_ate } }
