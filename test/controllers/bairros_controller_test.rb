...
class BairrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bairro" do
    assert_difference('Bairro.count') do
      post bairros_url, params: { bairro: { cidade_id: @bairro.cidade_id, latitude: @bairro.latitude, longitude: @bairro.longitude, nome: @bairro.nome } }
    end
  ...
  test "should update bairro" do
    patch bairro_url(@bairro), params: { bairro: { cidade_id: @bairro.cidade_id, latitude: @bairro.latitude, longitude: @bairro.longitude, nome: @bairro.nome } }
