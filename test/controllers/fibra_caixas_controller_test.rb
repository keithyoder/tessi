...
class FibraCaixasControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create fibra_caixa' do
    assert_difference('FibraCaixa.count') do
      post fibra_caixas_url,
           params: { fibra_caixa: { capacidade: @fibra_caixa.capacidade, fibra_rede_id: @fibra_caixa.fibra_rede_id,
                                    nome: @fibra_caixa.nome } }
    end
  ...
  test 'should update fibra_caixa' do
    patch fibra_caixa_url(@fibra_caixa),
          params: { fibra_caixa: { capacidade: @fibra_caixa.capacidade, fibra_rede_id: @fibra_caixa.fibra_rede_id,
                                   nome: @fibra_caixa.nome } }
