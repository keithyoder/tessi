...
class PlanoEnviarAtributosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plano_enviar_atributo" do
    assert_difference('PlanoEnviarAtributo.count') do
      post plano_enviar_atributos_url, params: { plano_enviar_atributo: { atributo: @plano_enviar_atributo.atributo, op: @plano_enviar_atributo.op, plano_id: @plano_enviar_atributo.plano_id, valor: @plano_enviar_atributo.valor } }
    end
  ...
  test "should update plano_enviar_atributo" do
    patch plano_enviar_atributo_url(@plano_enviar_atributo), params: { plano_enviar_atributo: { atributo: @plano_enviar_atributo.atributo, op: @plano_enviar_atributo.op, plano_id: @plano_enviar_atributo.plano_id, valor: @plano_enviar_atributo.valor } }
