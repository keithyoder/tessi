...
class ConexaoVerificarAtributosControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create conexao_verificar_atributo' do
    assert_difference('ConexaoVerificarAtributo.count') do
      post conexao_verificar_atributos_url,
           params: { conexao_verificar_atributo: { atributo: @conexao_verificar_atributo.atributo,
                                                   conexao_id: @conexao_verificar_atributo.conexao_id, op: @conexao_verificar_atributo.op, valor: @conexao_verificar_atributo.valor } }
    end
  ...
  test 'should update conexao_verificar_atributo' do
    patch conexao_verificar_atributo_url(@conexao_verificar_atributo),
          params: { conexao_verificar_atributo: { atributo: @conexao_verificar_atributo.atributo,
                                                  conexao_id: @conexao_verificar_atributo.conexao_id, op: @conexao_verificar_atributo.op, valor: @conexao_verificar_atributo.valor } }
