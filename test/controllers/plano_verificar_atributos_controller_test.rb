...
class PlanoVerificarAtributosControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create plano_verificar_atributo' do
    assert_difference('PlanoVerificarAtributo.count') do
      post plano_verificar_atributos_url,
           params: { plano_verificar_atributo: { atributo: @plano_verificar_atributo.atributo, op: @plano_verificar_atributo.op,
                                                 plano_id: @plano_verificar_atributo.plano_id, valor: @plano_verificar_atributo.valor } }
    end
  ...
  test 'should update plano_verificar_atributo' do
    patch plano_verificar_atributo_url(@plano_verificar_atributo),
          params: { plano_verificar_atributo: { atributo: @plano_verificar_atributo.atributo, op: @plano_verificar_atributo.op,
                                                plano_id: @plano_verificar_atributo.plano_id, valor: @plano_verificar_atributo.valor } }
